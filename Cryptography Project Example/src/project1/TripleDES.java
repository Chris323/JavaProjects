...
public class TripleDES {
	...
	private static void DecryptTripleSDES(){
		...
		for(int i = 0; i < 4; i++){
			encryptDemoBytePlainText[i] = Decrypt(encryptDemoByteKey1[i], encryptDemoByteKey2[i], encryptDemoByteCipherText[i]);
	...
	private static void EncryptTripleSDES(){
		...
		for(int i = 0; i < 4; i++){
			encryptDemoByteCipherText[i] = Encrypt(encryptDemoByteKey1[i], encryptDemoByteKey2[i], encryptDemoBytePlainText[i]);
			showText(encryptDemoByteKey1[i]);
			System.out.print("       ");
			showText(encryptDemoByteKey2[i]);
			System.out.print("       ");
