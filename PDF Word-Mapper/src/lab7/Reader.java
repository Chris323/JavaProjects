...
public class Reader {
	...
	public HashMap<String, Integer> booga = new LinkedHashMap<String, Integer>();
	...
	public HashMap<String, Integer> wordCounter(String input) {
		...
		for (Map.Entry<String, Integer> mapa : list) { 
            booga.put(mapa.getKey(), mapa.getValue());
            
        }
//		System.out.println(booga);
		for(String key : booga.keySet()) {
			System.out.println(key + " and " + booga.get(key));
		}
